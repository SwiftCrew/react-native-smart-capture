...
export const PreviewScreen: React.FC<PreviewScreenProps> = ({
  ...
  const initialScreen = React.useMemo(() => Dimensions.get('window'), []);
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.cropArea} onLayout={handleCropAreaLayout}>
        {loadError ? (
          ...
          <ImageCropper
            ...
            strokeColor={resolvedUI.colors.textInverse}
      ...
      <View style={styles.bottomBar}>
        ...
        >
          <Text style={styles.cancelButtonLabel}>{resolvedUI.strings.previewCancel}</Text>
        </Pressable>
